  ...
  ['LoopBackResource', 'LoopBackAuth', '$injector', function(Resource, LoopBackAuth, $injector) {
    var R = Resource(
      ...
      { 'id': '@id' },
      {
        ...
        // INTERNAL. Use Document.user() instead.
        "::get::document::user": {
          url: urlBase + "/documents/:id/user",
          method: "GET"
        },
  ...
  ['LoopBackResource', 'LoopBackAuth', '$injector', function(Resource, LoopBackAuth, $injector) {
    var R = Resource(
      ...
      { 'id': '@id' },
      {
        ...
        // INTERNAL. Use Account.entries.findById() instead.
        "prototype$__findById__entries": {
          url: urlBase + "/accounts/:id/entries/:fk",
          method: "GET"
        },

        // INTERNAL. Use Account.entries.destroyById() instead.
        "prototype$__destroyById__entries": {
          url: urlBase + "/accounts/:id/entries/:fk",
          method: "DELETE"
        },

        // INTERNAL. Use Account.entries.updateById() instead.
        "prototype$__updateById__entries": {
          url: urlBase + "/accounts/:id/entries/:fk",
          method: "PUT"
        },

        // INTERNAL. Use Account.entries() instead.
        "prototype$__get__entries": {
          isArray: true,
          url: urlBase + "/accounts/:id/entries",
          method: "GET"
        },

        // INTERNAL. Use Account.entries.create() instead.
        "prototype$__create__entries": {
          url: urlBase + "/accounts/:id/entries",
          method: "POST"
        },

        // INTERNAL. Use Account.entries.destroyAll() instead.
        "prototype$__delete__entries": {
          url: urlBase + "/accounts/:id/entries",
          method: "DELETE"
        },

        // INTERNAL. Use Account.entries.count() instead.
        "prototype$__count__entries": {
          url: urlBase + "/accounts/:id/entries/count",
          method: "GET"
        },
    ...
    */
    ...
    /**
     * @ngdoc object
     * @name lbServices.Account.entries
     * @header lbServices.Account.entries
     * @object
     * @description
     *
     * The object `Account.entries` groups methods
     * manipulating `Entry` instances related to `Account`.
     *
     * Call {@link lbServices.Account#entries Account.entries()}
     ...
     */
        ...
        R.entries = function() {
          ...
          var action = TargetResource["::get::account::entries"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Account.entries#count
         * @methodOf lbServices.Account.entries
         *
         * @description
         *
         * Counts entries of account.
         *
         * @param {Object=} parameters Request parameters.
         *
         *  - `id` – `{*}` - PersistedModel id
        ...
        R.entries.count = function() {
          var TargetResource = $injector.get("Entry");
          var action = TargetResource["::count::account::entries"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Account.entries#create
         * @methodOf lbServices.Account.entries
         *
         * @description
         *
        ...
        R.entries.create = function() {
          var TargetResource = $injector.get("Entry");
          var action = TargetResource["::create::account::entries"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Account.entries#destroyAll
         * @methodOf lbServices.Account.entries
         *
         * @description
         *
        ...
        R.entries.destroyAll = function() {
          var TargetResource = $injector.get("Entry");
          var action = TargetResource["::delete::account::entries"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Account.entries#destroyById
         * @methodOf lbServices.Account.entries
         *
         * @description
         *
        ...
        R.entries.destroyById = function() {
          var TargetResource = $injector.get("Entry");
          var action = TargetResource["::destroyById::account::entries"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Account.entries#findById
         * @methodOf lbServices.Account.entries
         *
         * @description
         *
        ...
        R.entries.findById = function() {
          var TargetResource = $injector.get("Entry");
          var action = TargetResource["::findById::account::entries"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Account.entries#updateById
         * @methodOf lbServices.Account.entries
         *
         * @description
         *
        ...
        R.entries.updateById = function() {
          var TargetResource = $injector.get("Entry");
          var action = TargetResource["::updateById::account::entries"];
          return action.apply(R, arguments);
        };
  ...
  ['LoopBackResource', 'LoopBackAuth', '$injector', function(Resource, LoopBackAuth, $injector) {
    var R = Resource(
      ...
      { 'id': '@id' },
      {
        ...
        // INTERNAL. Use Document.transactions.findById() instead.
        "::findById::document::transactions": {
          url: urlBase + "/documents/:id/transactions/:fk",
          method: "GET"
        },

        // INTERNAL. Use Document.transactions.destroyById() instead.
        "::destroyById::document::transactions": {
          url: urlBase + "/documents/:id/transactions/:fk",
          method: "DELETE"
        },

        // INTERNAL. Use Document.transactions.updateById() instead.
        "::updateById::document::transactions": {
          url: urlBase + "/documents/:id/transactions/:fk",
          method: "PUT"
        },

        // INTERNAL. Use Document.transactions() instead.
        "::get::document::transactions": {
          isArray: true,
          url: urlBase + "/documents/:id/transactions",
          method: "GET"
        },

        // INTERNAL. Use Document.transactions.create() instead.
        "::create::document::transactions": {
          url: urlBase + "/documents/:id/transactions",
          method: "POST"
        },

        // INTERNAL. Use Document.transactions.destroyAll() instead.
        "::delete::document::transactions": {
          url: urlBase + "/documents/:id/transactions",
          method: "DELETE"
        },

        // INTERNAL. Use Document.transactions.count() instead.
        "::count::document::transactions": {
          url: urlBase + "/documents/:id/transactions/count",
          method: "GET"
        },

        // INTERNAL. Use Entry.transaction() instead.
        "::get::entry::transaction": {
          url: urlBase + "/entries/:id/transaction",
          method: "GET"
        },
      }
    );
  ...
  ['LoopBackResource', 'LoopBackAuth', '$injector', function(Resource, LoopBackAuth, $injector) {
    var R = Resource(
      ...
      { 'id': '@id' },
      {
        ...
        // INTERNAL. Use Contact.documents.findById() instead.
        "prototype$__findById__documents": {
          url: urlBase + "/contacts/:id/documents/:fk",
          method: "GET"
        },

        // INTERNAL. Use Contact.documents.destroyById() instead.
        "prototype$__destroyById__documents": {
          url: urlBase + "/contacts/:id/documents/:fk",
          method: "DELETE"
        },

        // INTERNAL. Use Contact.documents.updateById() instead.
        "prototype$__updateById__documents": {
          url: urlBase + "/contacts/:id/documents/:fk",
          method: "PUT"
        },

        // INTERNAL. Use Contact.documents() instead.
        "prototype$__get__documents": {
          isArray: true,
          url: urlBase + "/contacts/:id/documents",
          method: "GET"
        },

        // INTERNAL. Use Contact.documents.create() instead.
        "prototype$__create__documents": {
          url: urlBase + "/contacts/:id/documents",
          method: "POST"
        },

        // INTERNAL. Use Contact.documents.destroyAll() instead.
        "prototype$__delete__documents": {
          url: urlBase + "/contacts/:id/documents",
          method: "DELETE"
        },

        // INTERNAL. Use Contact.documents.count() instead.
        "prototype$__count__documents": {
          url: urlBase + "/contacts/:id/documents/count",
          method: "GET"
        },
        ...
        // INTERNAL. Use Document.contacts() instead.
        "::get::document::contacts": {
          url: urlBase + "/documents/:id/contacts",
          method: "GET"
        },

        // INTERNAL. Use Document.contacts.create() instead.
        "::create::document::contacts": {
          url: urlBase + "/documents/:id/contacts",
          method: "POST"
        },

        // INTERNAL. Use Document.contacts.update() instead.
        "::update::document::contacts": {
          url: urlBase + "/documents/:id/contacts",
          method: "PUT"
        },

        // INTERNAL. Use Document.contacts.destroy() instead.
        "::destroy::document::contacts": {
          url: urlBase + "/documents/:id/contacts",
          method: "DELETE"
        },
      }
    ...
    */
    ...
    /**
     * @ngdoc object
     * @name lbServices.Contact.documents
     * @header lbServices.Contact.documents
     * @object
     * @description
     *
     * The object `Contact.documents` groups methods
     * manipulating `Document` instances related to `Contact`.
     *
     * Call {@link lbServices.Contact#documents Contact.documents()}
     * to query all related instances.
     */
        ...
        R.documents = function() {
          ...
          var action = TargetResource["::get::contact::documents"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Contact.documents#count
         * @methodOf lbServices.Contact.documents
         *
         * @description
         *
         * Counts documents of contact.
         *
         * @param {Object=} parameters Request parameters.
         *
         *  - `id` – `{*}` - PersistedModel id
        ...
        R.documents.count = function() {
          var TargetResource = $injector.get("Document");
          var action = TargetResource["::count::contact::documents"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Contact.documents#create
         * @methodOf lbServices.Contact.documents
         *
         * @description
         *
        ...
        R.documents.create = function() {
          var TargetResource = $injector.get("Document");
          var action = TargetResource["::create::contact::documents"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Contact.documents#destroyAll
         * @methodOf lbServices.Contact.documents
         *
         * @description
         *
        ...
        R.documents.destroyAll = function() {
          var TargetResource = $injector.get("Document");
          var action = TargetResource["::delete::contact::documents"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Contact.documents#destroyById
         * @methodOf lbServices.Contact.documents
         *
         * @description
         *
        ...
        R.documents.destroyById = function() {
          var TargetResource = $injector.get("Document");
          var action = TargetResource["::destroyById::contact::documents"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Contact.documents#findById
         * @methodOf lbServices.Contact.documents
         *
         * @description
         *
        ...
        R.documents.findById = function() {
          var TargetResource = $injector.get("Document");
          var action = TargetResource["::findById::contact::documents"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Contact.documents#updateById
         * @methodOf lbServices.Contact.documents
         *
         * @description
         *
        ...
        R.documents.updateById = function() {
          var TargetResource = $injector.get("Document");
          var action = TargetResource["::updateById::contact::documents"];
          return action.apply(R, arguments);
        };
  ...
  ['LoopBackResource', 'LoopBackAuth', '$injector', function(Resource, LoopBackAuth, $injector) {
    var R = Resource(
      ...
      { 'id': '@id' },
      {
        ...
        // INTERNAL. Use Document.contacts.update() instead.
        "prototype$__update__contacts": {
          url: urlBase + "/documents/:id/contacts",
          method: "PUT"
        },

        // INTERNAL. Use Document.contacts.destroy() instead.
        "prototype$__destroy__contacts": {
          url: urlBase + "/documents/:id/contacts",
          method: "DELETE"
        },
        ...
        // INTERNAL. Use Contact.documents.findById() instead.
        "::findById::contact::documents": {
          url: urlBase + "/contacts/:id/documents/:fk",
          method: "GET"
        },

        // INTERNAL. Use Contact.documents.destroyById() instead.
        "::destroyById::contact::documents": {
          url: urlBase + "/contacts/:id/documents/:fk",
          method: "DELETE"
        },

        // INTERNAL. Use Contact.documents.updateById() instead.
        "::updateById::contact::documents": {
          url: urlBase + "/contacts/:id/documents/:fk",
          method: "PUT"
        },
    ...
    */
    R.modelName = "Document";
        ...
        R.user = function() {
          var TargetResource = $injector.get("User");
          var action = TargetResource["::get::document::user"];
          return action.apply(R, arguments);
        };
    /**
     * @ngdoc object
     * @name lbServices.Document.transactions
     * @header lbServices.Document.transactions
     * @object
     * @description
     *
     * The object `Document.transactions` groups methods
     * manipulating `Transaction` instances related to `Document`.
     *
     * Call {@link lbServices.Document#transactions Document.transactions()}
     * to query all related instances.
     */
         ...
         * @description
         *
         * Queries transactions of document.
         *
         * @param {Object=} parameters Request parameters.
         *
         *  - `id` – `{*}` - PersistedModel id
        ...
        R.transactions = function() {
          ...
          var action = TargetResource["::get::document::transactions"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Document.transactions#count
         * @methodOf lbServices.Document.transactions
         *
         * @description
         *
         * Counts transactions of document.
         *
         * @param {Object=} parameters Request parameters.
         *
         *  - `id` – `{*}` - PersistedModel id
        ...
        R.transactions.count = function() {
          var TargetResource = $injector.get("Transaction");
          var action = TargetResource["::count::document::transactions"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Document.transactions#create
         * @methodOf lbServices.Document.transactions
         *
         * @description
         *
        ...
        R.transactions.create = function() {
          var TargetResource = $injector.get("Transaction");
          var action = TargetResource["::create::document::transactions"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Document.transactions#destroyAll
         * @methodOf lbServices.Document.transactions
         *
         * @description
         *
        ...
        R.transactions.destroyAll = function() {
          var TargetResource = $injector.get("Transaction");
          var action = TargetResource["::delete::document::transactions"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Document.transactions#destroyById
         * @methodOf lbServices.Document.transactions
         *
         * @description
         *
        ...
        R.transactions.destroyById = function() {
          var TargetResource = $injector.get("Transaction");
          var action = TargetResource["::destroyById::document::transactions"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Document.transactions#findById
         * @methodOf lbServices.Document.transactions
         *
         * @description
         *
        ...
        R.transactions.findById = function() {
          var TargetResource = $injector.get("Transaction");
          var action = TargetResource["::findById::document::transactions"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Document.transactions#updateById
         * @methodOf lbServices.Document.transactions
         *
         * @description
         *
        ...
        R.transactions.updateById = function() {
          var TargetResource = $injector.get("Transaction");
          var action = TargetResource["::updateById::document::transactions"];
          return action.apply(R, arguments);
        };
    /**
     * @ngdoc object
     * @name lbServices.Document.contacts
     * @header lbServices.Document.contacts
     * @object
     * @description
     *
     * The object `Document.contacts` groups methods
     * manipulating `Contact` instances related to `Document`.
     *
     * Call {@link lbServices.Document#contacts Document.contacts()}
     * to query all related instances.
     */
         ...
         * @description
         *
         * Fetches hasOne relation contacts.
         *
         * @param {Object=} parameters Request parameters.
         *
         *  - `id` – `{*}` - PersistedModel id
        ...
        R.contacts = function() {
          ...
          var action = TargetResource["::get::document::contacts"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Document.contacts#create
         * @methodOf lbServices.Document.contacts
         *
         * @description
         *
        ...
        R.contacts.create = function() {
          var TargetResource = $injector.get("Contact");
          var action = TargetResource["::create::document::contacts"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Document.contacts#destroy
         * @methodOf lbServices.Document.contacts
         *
         * @description
         *
         * Deletes contacts of this model.
         *
         * @param {Object=} parameters Request parameters.
         *
         *  - `id` – `{*}` - PersistedModel id
         ...
         * This method returns no data.
         */
        R.contacts.destroy = function() {
          var TargetResource = $injector.get("Contact");
          var action = TargetResource["::destroy::document::contacts"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Document.contacts#update
         * @methodOf lbServices.Document.contacts
         *
         * @description
         *
         * Update contacts of this model.
         *
         * @param {Object=} parameters Request parameters.
         *
         *  - `id` – `{*}` - PersistedModel id
         ...
         * </em>
         */
        R.contacts.update = function() {
          var TargetResource = $injector.get("Contact");
          var action = TargetResource["::update::document::contacts"];
          return action.apply(R, arguments);
        };
  ...
  ['LoopBackResource', 'LoopBackAuth', '$injector', function(Resource, LoopBackAuth, $injector) {
    var R = Resource(
      ...
      { 'id': '@id' },
      {
        ...
        // INTERNAL. Use Account.entries.findById() instead.
        "::findById::account::entries": {
          url: urlBase + "/accounts/:id/entries/:fk",
          method: "GET"
        },

        // INTERNAL. Use Account.entries.destroyById() instead.
        "::destroyById::account::entries": {
          url: urlBase + "/accounts/:id/entries/:fk",
          method: "DELETE"
        },

        // INTERNAL. Use Account.entries.updateById() instead.
        "::updateById::account::entries": {
          url: urlBase + "/accounts/:id/entries/:fk",
          method: "PUT"
        },
    ...
    */
    R.modelName = "Entry";
        ...
        /**
         * @ngdoc method
         * @name lbServices.Entry#transaction
         * @methodOf lbServices.Entry
         *
         * @description
         *
        ...
        R.transaction = function() {
          var TargetResource = $injector.get("Transaction");
          var action = TargetResource["::get::entry::transaction"];
          return action.apply(R, arguments);
        };
